...
namespace Starlight.API.Game.Players
{
	public interface IPlayerController
	{
        ...
        Task<IPlayerData> GetPlayerDataByIdAsync(uint id);
        ...
        /// <returns>The player data upon task completion</returns>
        Task<IPlayerData> GetPlayerDataBySsoAsync(string sso);
        ...
        /// <returns>The player data upon task completion</returns>
        Task<uint> GetPlayerIdByUsernameAsync(string username);
        ...
        /// <param name="playerId">The id associated with the player.</param>
        /// <returns>The player upon completion</returns>
        Task<IPlayer> GetPlayerByIdAsync(uint playerId);
